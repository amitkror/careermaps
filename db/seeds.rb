...
e = FactoryGirl.create(:education_level,
...
e = FactoryGirl.create(:job_education_level,
...
e = FactoryGirl.create(:question,
  title: 'You\'re happiest when you\'re:',
  order:4,
)

f = FactoryGirl.create(:answer,
  question_id: '1',
...
f = FactoryGirl.create(:answer,
  question_id: '1',
  text: 'Interacting with data and computers',
  order:2,
)

f = FactoryGirl.create(:answer,
  question_id: '2',
  text: 'Having a predictable work week',
  order:1,
)

f = FactoryGirl.create(:answer,
  question_id: '2',
  text: 'Thriving in a fast-paced environment',
  order:2,
)

f = FactoryGirl.create(:answer,
  question_id: '3',
  text: 'Help a business meet financial goals?',
  order:1,
)

f = FactoryGirl.create(:answer,
  question_id: '3',
  text: 'Help people thrive and grow?',
  order:2,
)
...
f = FactoryGirl.create(:answer,
  question_id: '4',
  text: 'Making or fixing something',
  order:2,
)
